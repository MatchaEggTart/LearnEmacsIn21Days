...
* 操作
  ...
  * 块模式选择
    ...
    按键|功能
    ---|---
    C-x &lt;SPACE&gt;| 进入/退出 cua模式

    命令|功能
    ---|---
    cua-mode| 进入/退出 cua模式
  ...
  * 字数统计
    ...
    指令|功能
    ---|---
    count-words-region| 光标所在行之前区域统计字数
    count-words| 选中区域统计字数
